...
assert.match(html,/app\.js\?v=20260915-tag-matrix-v1/,'carrier preparation and bulk refresh phase UI must use a fresh deployed app version');
...
assert.match(html,/seller-file-workflow-v2\.js\?v=20260915-tag-matrix-v1/,'seller file workflow must deploy the connected TransformationPlan UI');
assert.match(html,/data-service\.js\?v=20260915-tag-matrix-v1/,'data service must deploy targeted carrier lookup with a fresh version');
