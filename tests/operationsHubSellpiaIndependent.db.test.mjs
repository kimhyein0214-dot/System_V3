...
test('independent patch RPC enforces sessions, exact search, missing/stale/inactive values and bounded reads',async()=>{
 ...
 create table public.sellpia_stock_snapshot_rows(snapshot_id uuid,sellpia_sku_code text,sellpia_product_code text,sellpia_product_name text,sellpia_option_name text,purchase_price numeric,stock integer);
 ...
 insert into public.sellpia_stock_snapshot_rows select '00000000-0000-4000-8000-000000000001',s,'5566','14K 피어싱','옵션',53500,90 from unnest(array['5566-1','5566-10','5566-4'])s;
