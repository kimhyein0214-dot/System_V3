...
assert.match(app, /matrixZoom \/ 100[\s\S]*?startWidth \+ delta/, 'drag distance must remain correct at every matrix zoom level');
...
assert.match(html, /헤더 경계 드래그: 열 너비 조절[\s\S]*?경계 더블클릭: 기본 너비/, 'the matrix legend must explain column resizing');
