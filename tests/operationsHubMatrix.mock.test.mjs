...
assert.match(html, /style\.css\?v=20260907-price-reverse-v78[\s\S]*?data-service\.js\?v=20260907-price-reverse-v78[\s\S]*?app\.js\?v=20260907-price-reverse-v78/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
