...
assert.match(html, /style\.css\?v=[^"\s]+[\s\S]*?data-service\.js\?v=[^"\s]+[\s\S]*?app\.js\?v=[^"\s]+/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
