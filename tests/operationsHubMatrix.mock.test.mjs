...
assert.match(html, /style\.css\?v=20260827-option-copy-r49[\s\S]*?data-service\.js\?v=20260827-option-copy-r49[\s\S]*?app\.js\?v=20260827-option-copy-r49/, "the deployed page must invalidate cached assets when same-product option linking ships");
