...
assert.match(html, /style\.css\?v=20260903-operations-phase2-v73[\s\S]*?data-service\.js\?v=20260903-operations-phase2-v73[\s\S]*?app\.js\?v=20260903-operations-phase2-v73/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
