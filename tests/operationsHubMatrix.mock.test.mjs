...
assert.match(html, /style\.css\?v=20260827-context-refresh-r48[\s\S]*?data-service\.js\?v=20260827-context-refresh-r48[\s\S]*?app\.js\?v=20260827-context-refresh-r48/, "the deployed page must invalidate cached assets when source refresh moves into the context menu");
