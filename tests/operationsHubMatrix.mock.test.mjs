...
assert.match(html, /style\.css\?v=20260831-relation-excel-import-r58[\s\S]*?data-service\.js\?v=20260831-relation-excel-import-r58[\s\S]*?app\.js\?v=20260831-relation-excel-import-r58/, "the deployed page must invalidate cached assets when the relation Excel importer ships");
