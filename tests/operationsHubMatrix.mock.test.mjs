...
assert.match(html, /style\.css\?v=20260831-matrix-request-stability-r61[\s\S]*?data-service\.js\?v=20260831-matrix-request-stability-r61[\s\S]*?app\.js\?v=20260831-matrix-request-stability-r61/, "the deployed page must invalidate cached assets for matrix request stabilization");
