...
assert.match(html, /style\.css\?v=20260901-seller-bundle-v66[\s\S]*?data-service\.js\?v=20260901-seller-bundle-v66[\s\S]*?app\.js\?v=20260901-seller-bundle-v66/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
