...
assert.match(html, /style\.css\?v=20260831-relation-pointer-board-r57[\s\S]*?data-service\.js\?v=20260831-relation-pointer-board-r57[\s\S]*?app\.js\?v=20260831-relation-pointer-board-r57/, "the deployed page must invalidate cached assets when the option relation drag board ships");
