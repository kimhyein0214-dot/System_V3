...
assert.match(html, /style\.css\?v=20260827-product-draft-r50[\s\S]*?data-service\.js\?v=20260827-product-draft-r50[\s\S]*?app\.js\?v=20260827-product-draft-r50/, "the deployed page must invalidate cached assets when two-step product copy ships");
