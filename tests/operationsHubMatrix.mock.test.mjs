...
assert.match(html, /style\.css\?v=20260827-relation-folders-r53[\s\S]*?data-service\.js\?v=20260827-relation-folders-r53[\s\S]*?app\.js\?v=20260827-relation-folders-r53/, "the deployed page must invalidate cached assets when relation folders and natural SKU ordering ship");
