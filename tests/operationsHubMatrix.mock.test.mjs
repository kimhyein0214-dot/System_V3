...
assert.match(html, /style\.css\?v=20260903-price-basis-v74[\s\S]*?data-service\.js\?v=20260903-price-basis-v74[\s\S]*?app\.js\?v=20260903-price-basis-v74/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
