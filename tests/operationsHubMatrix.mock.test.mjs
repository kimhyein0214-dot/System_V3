...
assert.match(html, /style\.css\?v=20260827-link-recovery-r51[\s\S]*?data-service\.js\?v=20260827-link-recovery-r51[\s\S]*?app\.js\?v=20260827-link-recovery-r51/, "the deployed page must invalidate cached assets when resilient link writes ship");
