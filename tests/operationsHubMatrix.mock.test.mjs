...
assert.match(html, /style\.css\?v=20260827-group-divider-r47[\s\S]*?data-service\.js\?v=20260827-group-divider-r47[\s\S]*?app\.js\?v=20260827-group-divider-r47/, "the deployed page must invalidate cached assets when seller group dividers ship");
