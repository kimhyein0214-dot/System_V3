...
assert.match(html, /style\.css\?v=20260827-matrix-navigation-r52[\s\S]*?data-service\.js\?v=20260827-matrix-navigation-r52[\s\S]*?app\.js\?v=20260827-matrix-navigation-r52/, "the deployed page must invalidate cached assets when matrix navigation fixes ship");
