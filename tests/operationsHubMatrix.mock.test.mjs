...
assert.match(html, /style\.css\?v=20260827-relation-workspace-r55[\s\S]*?data-service\.js\?v=20260827-relation-workspace-r55[\s\S]*?app\.js\?v=20260827-relation-workspace-r55/, "the deployed page must invalidate cached assets when the scoped relation workspace ships");
