...
assert.match(html, /style\.css\?v=20260827-relation-graph-r54[\s\S]*?data-service\.js\?v=20260827-relation-graph-r54[\s\S]*?app\.js\?v=20260827-relation-graph-r54/, "the deployed page must invalidate cached assets when the arbitrary-depth relation graph ships");
