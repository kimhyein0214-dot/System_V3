...
assert.match(html, /style\.css\?v=20260903-managed-connections-v71[\s\S]*?data-service\.js\?v=20260903-managed-connections-v71[\s\S]*?app\.js\?v=20260903-managed-connections-v71/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
