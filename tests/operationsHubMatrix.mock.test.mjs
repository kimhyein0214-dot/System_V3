...
assert.match(html, /style\.css\?v=20260901-ui-scale-v67[\s\S]*?data-service\.js\?v=20260901-ui-scale-v67[\s\S]*?app\.js\?v=20260901-ui-scale-v67/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
