...
assert.match(html, /style\.css\?v=20260903-batch-safety-v76[\s\S]*?data-service\.js\?v=20260903-batch-safety-v76[\s\S]*?app\.js\?v=20260903-batch-safety-v76/, "the deployed page must invalidate cached assets for bundled matrix metadata reads");
