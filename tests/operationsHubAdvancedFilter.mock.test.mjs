...
assert.match(html,/data-service\.js\?v=20260915-source-refresh-v1[\s\S]*?app\.js\?v=20260915-bulk-progress-v1/,"the optimized data service and current app bundle must both be cache-versioned");
