...
assert.match(html,/data-service\.js\?v=20260915-carrier-plan-v2[\s\S]*?app\.js\?v=20260915-carrier-plan-v2/,"the optimized data service and current app bundle must both be cache-versioned");
