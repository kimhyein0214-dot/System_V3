...
assert.match(css, /\.shortage-layout\s*\{\s*grid-template-columns:\s*384px minmax\(0, 1fr\);\s*\}/);
assert.match(
  css,
...
console.log("Shortage target list is 20 percent wider without changing other workflow tabs: passed");
