...
assert.match(html, /id="matrix-context-menu"[\s\S]*?id="matrix-context-source-refresh"[\s\S]*?id="matrix-context-source-refresh-count"[\s\S]*?id="matrix-context-disconnect"[\s\S]*?id="matrix-context-disconnect-count"/, 'the matrix must expose source refresh and exact disconnect actions in its right-click work menu');
