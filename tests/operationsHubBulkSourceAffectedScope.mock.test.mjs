...
assert.match(html, /data-service\.js\?v=20260921-bounded-source-refresh-v2[\s\S]*app\.js\?v=20260921-bounded-source-refresh-v2[\s\S]*price-result-materializer\.js\?v=20260921-bounded-source-refresh-v1/, 'the deployed page must cache-bust every changed source-refresh asset');
