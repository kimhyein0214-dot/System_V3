...
assert.match(html, /ui-scale-base\.css\?v=20260903-relation-filter-v75[\s\S]*?ui-scale-matrix\.css\?v=20260903-relation-filter-v75[\s\S]*?ui-scale-workspaces\.css\?v=20260903-relation-filter-v75/, '27-inch scale overrides must load after the legacy page styles');
