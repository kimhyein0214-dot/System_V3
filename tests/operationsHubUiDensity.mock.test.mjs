...
assert.match(html, /ui-scale-base\.css\?v=20260907-price-reverse-v78[\s\S]*?ui-scale-matrix\.css\?v=20260907-price-reverse-v78[\s\S]*?ui-scale-workspaces\.css\?v=20260907-price-reverse-v78/, '27-inch scale overrides must load after the legacy page styles');
