...
assert.match(html, /style\.css\?v=20260901-sellpia-preflight-r64[\s\S]*?app\.js\?v=20260901-sellpia-preflight-r64/, 'the deployed page must invalidate cached shell assets');
