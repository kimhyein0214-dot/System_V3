...
assert.match(html, /style\.css\?v=20260831-matrix-page-first-r62[\s\S]*?app\.js\?v=20260831-matrix-page-first-r62/, 'the deployed page must invalidate cached shell assets');
