...
assert.match(html, /style\.css\?v=20260831-matrix-metadata-bundle-r63[\s\S]*?app\.js\?v=20260831-matrix-metadata-bundle-r63/, 'the deployed page must invalidate cached shell assets');
