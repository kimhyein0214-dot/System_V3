...
assert.match(html, /style\.css\?v=20260903-relation-filter-v75[\s\S]*?app\.js\?v=20260903-relation-filter-v75/, 'the deployed page must invalidate cached shell assets');
