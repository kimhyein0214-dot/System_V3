...
test('grid loader rejects duplicates, manifest drift, and stalled cursors',async()=>{
  const manifest={contract_version:5,total:2,dataset_version:'2026-09-20T00:00:00Z',recommended_chunk_size:2000,max_chunk_size:4000,tag_catalog:{},link_badges:[],page_cursors:[null]};
...
test('grid loader retries only the failed page and never restarts the dataset',async()=>{
  ...
  const fixture=gridLoaderContext([
    {contract_version:5,total:1,dataset_version:version,recommended_chunk_size:2000,max_chunk_size:4000,tag_catalog:{},link_badges:[],page_cursors:[null]},
