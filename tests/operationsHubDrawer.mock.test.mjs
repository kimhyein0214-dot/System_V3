...
assert.match(app, /function renderDrawerPricePolicy[\s\S]*?퍼센트 할인[\s\S]*?금액 추가[\s\S]*?판매처 최종가 직접 지정/, "drawer prices must expose simple operator choices instead of internal pipeline jargon");
