...
assert.match(html, /data-service\.js\?v=20260921-tag-search-rounding-v2[\s\S]*app\.js\?v=20260921-queue-resilience-v2/, 'changed frontend assets must be cache-busted');
