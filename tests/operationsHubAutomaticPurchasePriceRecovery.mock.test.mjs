...
assert.match(html, /data-service\.js\?v=20260921-sellpia-source-overlay-v1[\s\S]*app\.js\?v=20260921-sellpia-source-overlay-v1/, 'changed frontend assets must be cache-busted');
