...
assert.match(css, /Matrix readability[\s\S]*?product-cell,[\s\S]*?option-cell,[\s\S]*?seller-identity-cell\{text-align:center;vertical-align:middle\}[\s\S]*?product-identity-merged-cell,[\s\S]*?seller-identity-merged-cell\{vertical-align:middle\}/, 'merged product identities and per-SKU option identities must share centered alignment');
