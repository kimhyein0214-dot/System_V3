-- Stabilize v5 by using the exact snapshot/product/option lookup index for
-- seller price tuples. The browser consumes 3,000-row pages sequentially,
-- avoiding the DB contention observed with concurrent bootstrap pages.
...
comment on function public.hub_matrix_grid_feed_v5(text,timestamptz,text,integer) is
  'Session-gated positional v5 feed using exact indexed seller snapshot tuple lookup.';
