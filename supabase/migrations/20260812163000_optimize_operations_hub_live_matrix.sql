...
comment on materialized view operations_private.operations_hub_matrix_core is
  'Cached mapping dimension for the operations hub. Refresh after mapping master data changes; stock and seller snapshots remain live joins.';
...
comment on view public.operations_hub_matrix_live is
  'Fast read-only SKU matrix backed by a cached mapping dimension and latest live inventory snapshots.';
