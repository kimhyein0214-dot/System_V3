...
-- v4 removes repeated row key names from the wire and publishes keyset page
-- cursors in the manifest so the browser can use bounded page concurrency.

create or replace function public.hub_matrix_grid_manifest_v4(
...
create or replace function public.hub_matrix_grid_feed_v4(
  p_session_token text,
...
revoke all on function public.hub_matrix_grid_manifest_v4(text,integer) from public;
revoke all on function public.hub_matrix_grid_manifest_v4(text,integer) from anon, authenticated;
grant execute on function public.hub_matrix_grid_manifest_v4(text,integer) to anon, authenticated, service_role;

revoke all on function public.hub_matrix_grid_feed_v4(text,timestamptz,text,integer) from public;
revoke all on function public.hub_matrix_grid_feed_v4(text,timestamptz,text,integer) from anon, authenticated;
grant execute on function public.hub_matrix_grid_feed_v4(text,timestamptz,text,integer) to anon, authenticated, service_role;

comment on function public.hub_matrix_grid_manifest_v4(text,integer) is
  'Session-gated manifest and keyset page cursors for the positional v4 Operations Hub Matrix Grid feed.';
comment on function public.hub_matrix_grid_feed_v4(text,timestamptz,text,integer) is
